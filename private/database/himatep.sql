...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Apr 2026 pada 20.46
...
(1, 'Seminar Nasional Teknologi Pendidikan 2026', 'seminar-nasional-tp-2026', 'Kegiatan', 'green', 'Divisi Humas', 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80', 'Membahas masa depan AI dalam dunia pendidikan tinggi di Indonesia dengan pembicara ahli.', '<p class=\"mb-4\">Himpunan Mahasiswa Teknologi Pendidikan (HIMATEP) FIP UNM sukses menyelenggarakan Seminar Nasional Teknologi Pendidikan 2026 dengan tema \"Masa Depan AI dalam Transformasi Pendidikan Tinggi di Indonesia\". Acara ini berlangsung meriah di Auditorium Ammanagappa dan dihadiri oleh lebih dari 500 peserta dari berbagai perguruan tinggi.</p>\r\n            <p class=\"mb-4\">Seminar ini menghadirkan tiga pembicara pakar di bidang kecerdasan buatan dan teknologi pembelajaran. Mereka menyoroti urgensi adaptasi dosen dan mahasiswa terhadap perangkat AI generatif, bukan sebagai ancaman, melainkan sebagai alat bantu kognitif yang kuat.</p>\r\n            <h3 class=\"text-xl font-bold mt-6 mb-3 text-himatep-dark\">Poin Penting Seminar</h3>\r\n            <ul class=\"list-disc pl-5 mb-4 text-gray-700 space-y-2\">\r\n                <li>Integrasi AI dalam kurikulum merdeka belajar.</li>\r\n                <li>Etika penggunaan ChatGPT dan AI lainnya dalam penulisan karya ilmiah.</li>\r\n                <li>Bagaimana lulusan Teknologi Pendidikan memposisikan diri di era otomatisasi cerdas.</li>\r\n            </ul>\r\n            <p class=\"mb-4\">Ketua Umum HIMATEP, Andi Syahrul, dalam sambutannya menyampaikan harapannya agar kegiatan ini menjadi katalisator inovasi mahasiswa FIP UNM. \"Kita tidak boleh tertinggal. Teknologi Pendidikan harus menjadi garda terdepan yang mendikte arah pendidikan masa depan, bukan sekadar penonton,\" tegasnya.</p>', '2026-04-12', '2026-04-25 15:37:20'),
...
INSERT INTO `pengurus` (`id`, `nama`, `jabatan`, `divisi`, `foto`, `urutan`, `periode`, `created_at`) VALUES
(1, 'Andi Syahrul', 'Ketua Umum', 'BPH', 'default.png', 1, '2026/2027', '2026-05-03 10:00:00');
...
(6, 'HIMATEP Menyapa (Kunjungan)', 'himatep-menyapa', 'Hubungan Masyarakat', 'green', 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9', 'Semester Genap', 'HIMA Eksternal', 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&q=80', 'Program kunjungan silaturahmi ke himpunan mahasiswa sejenis di universitas lain untuk bertukar informasi dan studi banding.', '<p>HIMATEP Menyapa adalah wadah kolaborasi antar himpunan untuk memperluas jaringan dan perspektif mahasiswa.</p>', 0, '2026-04-25 16:46:51');
