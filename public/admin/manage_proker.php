...
<body class="bg-gray-100 flex h-screen overflow-hidden" x-data="{ sidebarOpen: false, showImageModal: false, imageUrlInput: '', imageCaptionInput: '' }">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
            ...
            <a href="manage_proker.php" class="block py-3 px-4 rounded-lg bg-blue-800 font-medium">Program Kerja</a>
            ...
            <div class="xl:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-400 overflow-hidden">
                    ...
                    <div class="p-8 max-w-2xl mx-auto">
                        ...
                        <div id="preview-divisi" class="inline-block px-3 py-1 rounded-full text-xs font-bold text-white bg-blue-600 mb-4 uppercase tracking-wider">DIVISI</div>
